...
const Navbar1 = () => {
  ...
  return (
    <div className="flex justify-center w-full py-6 px-4">
      <div className="flex items-center justify-between px-6 py-3 bg-neutral-900/90 backdrop-blur-sm border border-white/10 rounded-full shadow-lg w-full max-w-3xl relative z-10">
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed inset-0 bg-neutral-950 z-50 pt-24 px-6 md:hidden"
            ...
            <div className="flex flex-col space-y-6">
              {["Home", "Pricing", "Docs", "Projects"].map((item, i) => (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 20 }}
                >
                  <a href="#" className="text-base text-white font-medium" onClick={toggleMenu}>
                    {item}
                  </a>
                </motion.div>
              ))}
